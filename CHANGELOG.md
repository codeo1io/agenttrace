...
- Workspace publish metadata (`repository`/`homepage`) now names this fork's remote instead of the upstream original, so crates.io/docs.rs links resolve to the home that actually publishes.
