...
const copy = {
  zh: {
    home: "首页", sessions: "会话", discover: "发现", compare: "对比", settings: "设置", systemHealthy: "系统运行正常",
  ...
  en: {
    home: "Home", sessions: "Sessions", discover: "Discover", compare: "Compare", settings: "Settings", systemHealthy: "System running normally",
