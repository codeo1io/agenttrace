# AgentTrace documentation

Use this index to find the document that matches your role and task.
...
- [Community pain points](research/community-pain-points.md) — product research inputs.
- [Rust migration status (v0.6 archive)](archive/rust-migration-status-v0.6.md)
- [Rust migration compatibility (v0.6 archive)](archive/rust-migration-compatibility-v0.6.md)
